...
function genericExport(args, callback) {
    ...
    if (args.addTimestampToFileName) {
        const fileNamePrefix = filename;
        const fileNameMiddle = site.ID;
    ...
    if (OverwriteExportFile !== true && FileHelper.isFileExists(targetFolder, exportFileName)) {
    ...
    var filePath = targetFolder + File.SEPARATOR + exportFileName;
