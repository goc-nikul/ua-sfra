...
import ParentProductDetail from 'org/components/product/ProductDetail';
...
export default class ProductDetail extends ParentProductDetail {
    ...
    onWindowScroll() {
        ...
        if (scroll >= 500) {
            $stickyCta.addClass('cta-expanded');
        } else if (scroll < 500) {
            $stickyCta.removeClass('cta-expanded');
        }
    }
