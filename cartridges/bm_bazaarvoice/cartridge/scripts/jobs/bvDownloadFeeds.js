...
function execute (parameters, stepExecution) {
	try {
		...
		var fileExists = ftpClient.listRemoteFiles(fpath, fname);
		...
		var deleteRemoteFile = parameters.DeleteFile;
		Logger.info('Download delete file from SFTP: ' + deleteRemoteFile);
        var downloadResult = ftpClient.downloadFile(fpath + File.SEPARATOR + fname, tempFile, deleteRemoteFile);
