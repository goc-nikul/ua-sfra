 ...
 * @param {Boolean} deleteRemoteFile Indicates if downloaded files should be removed from the SFTP server.
 * @throws {Error} If file could not be downloaded.
 */
FtpClientHelper.prototype.downloadFile = function (remoteFilePath, file, deleteRemoteFile) {
    ...
    if (!empty(deleteRemoteFile) && deleteRemoteFile === true) {
        this.removeRemoteFile(remoteFilePath);
    }
