...
// Require Base Cart scripts
var shippingHelpers = require('base/checkout/shipping');
var formHelpers = require('base/checkout/formErrors');
var scrollAnimate = require('base/components/scrollAnimate');
var summaryHelpers = require('base/checkout/summary');

// Require Custom Overriding scripts
var billingHelpers = require('./apbilling');
...
// Base cart checkout js
var base = require('base/checkout/checkout');

/**
* Overridding/renaming entire jQuery plugin from base as
* there is no clear way to override certain
* functions or properties within the plugin
*
* Base Cart Comments Begin
        ...
        var members = {
            ...
            updateStage: function () {
                ...
                if (stage === 'shipping') {
                    ...
                    var placeOrderUrl = $('.place-order').data('action');
...
// Overriding base cart initialize function from checkout js
...
// Export base cart checkout and new functions
module.exports = base;
