...
var ZipOrder = {
    ...
    /**
     * Return zip captured amount.
     *
     * @param {dw.order.Order} order Order.
     * @returns {number} zip captured amount.
     */
    ...
    /**
     * Return zip refunded amount.
     *
     * @param {dw.order.Order} order Order.
     * @returns {number} zip refunded amount.
     */
    ...
    /**
     * Return zip refundable amount.
     *
     * @param {dw.order.Order} order Order.
     * @returns {number} zip refundable amount.
     */
    ...
    /**
     * Return not captured zip amount.
     *
     * @param {dw.order.Order} order Order.
     * @returns {number} not captured zip amount.
     */
    ...
    /**
     * Check the amount is fully paid.
     *
     * @param {dw.order.Order} order Order.
     * @returns {boolean} true, if the amount is fully paid.
     */
    ...
    reflectCapture: function (order, capturedAmount) {
        ...
        ord.setExportStatus(require('dw/order/Order').EXPORT_STATUS_READY);
        if (require('dw/system/Site').current.getCustomPreferenceValue('isSetOrderConfirmationEmailStatusForJob')) {
            ord.custom.orderConfirmationEmailStatus = 'READY_FOR_PROCESSING'; // eslint-disable-line no-undef
        }
    },
    /**
    ...
    /**
     * Return zip receipt number.
     *
     * @param {dw.order.Order} order Order.
     * @returns {string} zip receipt number.
     */
