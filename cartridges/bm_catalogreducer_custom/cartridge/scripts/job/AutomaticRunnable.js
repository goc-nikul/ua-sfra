...
module.exports = {
    beforeStep: function(args) {
        ...
        rootDirectoryObj = 'fileName' in parameters && parameters.fileName ? Directories.prepareRootFolder(storefrontCatalogID, parameters.fileName) : Directories.prepareRootFolder(storefrontCatalogID);
    },
