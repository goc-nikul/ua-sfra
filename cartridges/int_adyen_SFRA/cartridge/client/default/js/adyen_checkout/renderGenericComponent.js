...
function renderPaymentMethods(data, imagePath, adyenDescriptions, paymentMethodNames) {
  data.paymentMethods.forEach(function (pm) {
    if (pm.type !== constants.GIFTCARD || store.giftcardBrand) {
      renderPaymentMethod(pm, false, imagePath, adyenDescriptions[pm.type], paymentMethodNames[pm.type]);
    } else {
      renderGiftCard(pm);
    }
  });
        ...
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            store.checkoutConfiguration.session = {
              ...
              paymentMethodNames: session.paymentMethodNames,
          ...
          case 9:
            ...
            renderPaymentMethods(store.checkout.paymentMethodsResponse, session.imagePath, session.adyenDescriptions, session.paymentMethodNames);
