 ...
 * @private
 */
    const customObjectName = 'OISAuthToken';
 ...
 */
    function getValidToken() {
        if (!this.isValidAuth()) {
            var payload = OISHelper.prepareOISTokenServiceRequest();
            var createOauthTokenService = OISDataService.getTokenData();
