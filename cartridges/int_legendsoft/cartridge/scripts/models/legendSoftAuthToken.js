...
const CUSTOM_OBJECT_KEY = 'legendsoft';
...
function callService() {
    ...
    var result = hooksHelper('app.address.suggestion', 'token');
...
module.exports = LegendSoftAuthToken;
