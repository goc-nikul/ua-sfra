 ...
 * @returns {string} formatted string
 */
function createPaypalRequestString(service, requestDataContainer, inpLogger, site) {
...
module.exports.getPayPalService = function (serviceID, site) {
    ...
    /**
        ...
        createRequest: function (inpService, requestDataContainer, logger, isIpn) {
            ...
            if (isIpn) {
                ...
                nvp = createPaypalRequestString(service, requestDataContainer, logger, site);
            }
            return nvp.toString();
        },
