...
ipn.isAuthentic = function (notification) {
    ...
    var serviceName = prefs.nvpServiceName + credentialEnding;
    try {
        service = require('*/cartridge/scripts/service/paypalHttpNvpServiceInit').getPayPalService(serviceName, null);
