        ...
        priceAdjustments = collections.map(lineItem.priceAdjustments, function (priceAdjustment) {
            if (priceAdjustment.promotion) {
                return {
                    ...
                    promotionClass: priceAdjustment.promotion.promotionClass,
                    rank: priceAdjustment.promotion.rank,
                    campaign: {
                        id: priceAdjustment.promotion.campaign.ID,
                        UUID: priceAdjustment.promotion.campaign.UUID,
                        description: priceAdjustment.promotion.campaign.description,
                        applicableInStore: priceAdjustment.promotion.campaign.applicableInStore,
                        applicableOnline: priceAdjustment.promotion.campaign.applicableOnline
                    }
                };
            }
            return {
