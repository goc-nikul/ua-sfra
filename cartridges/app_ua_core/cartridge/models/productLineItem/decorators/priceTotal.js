...
function getTotalPrice(product, lineItem) {
    ...
    if (!empty(product.price) && productPrice.list != null) {
        ...
        result.strikeThroughPrice = (typeof strikeThroughPrice.decimalPrice !== undefined && strikeThroughPrice.decimalPrice !== undefined && !empty(strikeThroughPrice.currency)) ? formatMoney(require('dw/value/Money')((strikeThroughPrice.decimalPrice * lineItem.quantityValue), strikeThroughPrice.currency)) : '';
    }
