...
function getMinMaxQuantityOptions(productLineItem, quantity) {
    var availableToSell = productLineItem.product.availabilityModel.inventoryRecord !== null ? productLineItem.product.availabilityModel.inventoryRecord.ATS.value : null;
    var perpetual = productLineItem.product.availabilityModel.inventoryRecord !== null ? productLineItem.product.availabilityModel.inventoryRecord.perpetual : false;
    var max;
