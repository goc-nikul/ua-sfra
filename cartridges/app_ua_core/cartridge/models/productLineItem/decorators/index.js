...
module.exports = {
    ...
    priceItem: require('*/cartridge/models/productLineItem/decorators/priceItem'),
    bonusUnitPrice: require('*/cartridge/models/productLineItem/decorators/bonusUnitPrice'),
    customAttributes: require('*/cartridge/models/productLineItem/decorators/customAttributes'),
    isOnline: require('*/cartridge/models/productLineItem/decorators/isOnline')
};
