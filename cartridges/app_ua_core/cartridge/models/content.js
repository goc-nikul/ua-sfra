...
function content(contentValue, renderingTemplate) {
    if (!contentValue || !contentValue.online) {
        return null;
    }
    ...
    this.coremediaPlacement = contentValue.custom.coremediaPlacement;
    this.coremediaView = contentValue.custom.coremediaView;
    this.coremediaId = contentValue.custom.coremediaId;
    return this;
}
