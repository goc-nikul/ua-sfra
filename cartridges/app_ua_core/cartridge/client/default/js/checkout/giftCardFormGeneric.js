            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response && response.data && response.data.success) {
                        ...
                        if (response.gcResults && response.gcResults.gcPaymentInstruments && response.gcResults.gcPaymentInstruments.length > 0) {
                            if (!$('.payment-information').hasClass('gc-pay-applied')) {
                                $('.payment-information').addClass('gc-pay-applied');
                            }
                        } else if ($('.payment-information').hasClass('gc-pay-applied')) {
                            $('.payment-information').removeClass('gc-pay-applied');
                        }
