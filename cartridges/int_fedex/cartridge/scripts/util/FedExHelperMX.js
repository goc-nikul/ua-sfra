module.exports = {
    /**
     * build address map object to send to FedEx for MX site
    ...
    getAddressMapFromOrder: function (order) {
        ...
        return {
            ...
            address2: addressData && addressData.shippingAddress && addressData.shippingAddress.custom ? addressData.shippingAddress.custom.exteriorNumber : '',
