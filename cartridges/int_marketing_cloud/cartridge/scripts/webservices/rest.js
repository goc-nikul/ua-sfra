...
RestService.prototype = {
    ...
    /**
     * Section: DataExtension
     * Name: Send Email
     * Documentation: https://developer.salesforce.com/docs/atlas.en-us.mc-apis.meta/mc-apis/insertDataExtensionIDAsync.htm
     * Endpoint: data/v1/async/dataextensions/{key}/rows
     * Method: POST
     * Content Type: JSON
     * Request Headers: Authorization
     * Request Args: SendID, key
     */
    dataExtensionSend: function dataExtensionSend() {
        var restSvc = this;
        return LocalServiceRegistry.createService('marketingcloud.rest.dataextension.send', {
            /**
             * Create request for adding dataExtension for egiftCards
             * @param {dw.svc.HTTPService} svc
             * @param {module:models/message~Message} message A message model instance to be sent to Marketing Cloud
             * @returns {string} Request body
             */
            createRequest: function(svc, message) {
                ...
                var svcURL = restSvc.token.restInstanceURL,
                    svcPath = '/data/v1/async/dataextensions/{key}/rows';
