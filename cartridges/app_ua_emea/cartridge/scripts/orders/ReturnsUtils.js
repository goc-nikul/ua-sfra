...
var eodReportMgr = require('app_ua_emea/cartridge/scripts/orders/EODReportMgr');
	...
	*/
    ...
    createReturnAccordingRefundLineItems: function (order, lineItems) {
        ...
        if (empty(returnCase)) {
            ...
            var shippingUtils = (new (require('app_ua_emea/cartridge/scripts/orders/ShippingUtils'))());
