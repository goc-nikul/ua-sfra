    ...
    ContactDataServices.address = function (customOptions) {
        ...
        instance.result = {
            ...
            show: function (data) {
                ...
                // Refresh Paazl widget post autocomplete of address
                $('#shippingZipCodedefault:visible').trigger('change');
            },
            hide: function () {
