...
describe('productAttributes', function () {
    var ProductAttributes = proxyquire('../../../../../cartridges/app_ua_emea/cartridge/models/product/productAttributes', {
    ...
    it('should return color attributes with multiple values', function () {
        ProductAttributes = proxyquire('../../../../../cartridges/app_ua_emea/cartridge/models/product/productAttributes', {
            '*/cartridge/scripts/util/collections': proxyquire('../../../../../cartridges/storefront-reference-architecture/cartridges/app_storefront_base/cartridge/scripts/util/collections', {
                'dw/util/ArrayList': ArrayList
            }),
            '*/cartridge/scripts/helpers/urlHelpers': { appendQueryParams: function () {
    ...
    it('variant should not be selectable --> master.custom.exclusive.value === out-of-stock', function () { // varient based color
        ProductAttributes = proxyquire('../../../../../cartridges/app_ua_emea/cartridge/models/product/productAttributes', {
            '*/cartridge/scripts/util/collections': proxyquire('../../../../../cartridges/storefront-reference-architecture/cartridges/app_storefront_base/cartridge/scripts/util/collections', {
                'dw/util/ArrayList': ArrayList
            }),
        ...
        assert.equal(attrs.length, 1);
        assert.equal(attrs[0].values[0].selectable, false);
    });

    it('variant should not be selectable --> colorVariant.custom.exclusive.value === out-of-stock', function () { // varient based color
        ProductAttributes = proxyquire('../../../../../cartridges/app_ua_emea/cartridge/models/product/productAttributes', {
            '*/cartridge/scripts/util/collections': proxyquire('../../../../../cartridges/storefront-reference-architecture/cartridges/app_storefront_base/cartridge/scripts/util/collections', {
                'dw/util/ArrayList': ArrayList
            }),
