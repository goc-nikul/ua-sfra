...
describe('int_mao/cartridge/models/UACAPI/returns/returnDetails.js', function () {
    const ReturnDetails = proxyquire('../../../../../cartridges/int_mao/cartridge/models/UACAPI/returns/returnDetails', {
    ...
    it('should throw an error when order items is null/empty', () => {
        ...
        var ReturnDetails = proxyquire('../../../../../cartridges/int_mao/cartridge/models/UACAPI/returns/returnDetails.js', {
            'dw/util/StringUtils': {},
            '*/cartridge/scripts/UACAPI/helpers/util/utilHelper': {
