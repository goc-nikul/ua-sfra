...
describe('int_mao/cartridge/models/UACAPI/order/order.js', () => {
    ...
    it('Testing model with edges is empty and orderDeliverThresholdDays is null', () => {
        ...
        var OrderModel = proxyquire('../../../../../cartridges/int_mao/cartridge/models/UACAPI/order/order.js', {
            'dw/util/StringUtils': require('../../../../mocks/dw/dw_util_StringUtils'),
            '*/cartridge/scripts/UACAPI/helpers/util/utilHelper': utilHelper,
