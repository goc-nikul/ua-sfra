...
describe('product variation attributes decorator', function () {
    var variationAttributes = proxyquire('../../../../../cartridges/app_ua_core/cartridge/models/product/decorators/variationAttributes', {
    ...
    it('should create a property on the passed in object called variationAttributes --> pass variationModel as null', function () {
        var object = { selectedQuantity: 2 };
