...
describe('int_OIS/cartridge/models/OIS/order/returns.js', function () {
    const ReturnModel = proxyquire('../../../../../cartridges/int_OIS/cartridge/models/OIS/order/returns', {
    ...
    it('should throw an error when order items is null/empty, using stub', () => {
        ...
        var ReturnModel = proxyquire('../../../../../cartridges/int_OIS/cartridge/models/OIS/order/returns.js', {
            'dw/util/StringUtils': {},
            '*/cartridge/scripts/util/utilHelper': {
