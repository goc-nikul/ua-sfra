...
describe('bc_jobs/cartridge/scripts/catalog/AutoCategorizeNewArrivals.js', () => {
    var AutoCategorizeNewArrivals = proxyquire('../../../../cartridges/bc_jobs/cartridge/scripts/catalog/AutoCategorizeNewArrivals.js', {
        'dw/system/Logger': require('../../../mocks/dw/dw_system_Logger'),
        'dw/system/Status': require('../../../mocks/dw/dw_system_Status'),
        'dw/system/Site': require('../../../mocks/dw/dw_system_Site'),
        'dw/catalog/CatalogMgr': require('../../../mocks/scripts/AutoCategorizeNewArrival/dw_catalog_CatalogMgr'),
    ...
    it('Testing Job: handle exception', () => {
        var newArrivals = AutoCategorizeNewArrivals.autoCategorizeNewArrivals();
        ...
        assert.equal(newArrivals.status, Status.ERROR, 'Auto Categorize exception occured');
    });
    ...
    it('Testing Job: the job step is disabled', () => {
        ...
        assert.isNotNull(newArrivals, 'status is null');
        assert.isDefined(newArrivals, 'status is undefined');
        assert.equal(newArrivals.status, Status.OK, 'Auto Categorize new arrival disabled');
    });
    ...
    it('Testing Job: the job step is successful', () => {
        ...
        assert.isNotNull(newArrivals, 'status is null');
        assert.isDefined(newArrivals, 'status is undefined');
        assert.equal(newArrivals.status, Status.OK, 'Auto Categorize new arrival completed');
    });
