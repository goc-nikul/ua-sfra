...
var responseCase = 'ERROR';
var KlarnaPaymentsHttpService = proxyquire('../../../../../../cartridges/int_klarna_payments/cartridge/scripts/common/klarnaPaymentsHttpService.js', {
                ...
                call: (data) => {
                    if (responseCase === 'SUCCESS') {
                        ...
                        return {
                            ...
                            error: 404,
                            object: {
                                text: '{"error_code":"NOT_FOUND","error_messages":["Invalid session id"],"correlation_id":"279cbec8-75ba-4ee6-b112-21d2465380da"}'
                            }
                        };
                    }
