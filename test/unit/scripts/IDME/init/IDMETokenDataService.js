...
describe('int_IDME/cartridge/scripts/init/IDMETokenDataService.js', () => {


    it('Testing IDMETokenDataService: token and scope exists', () => {
        var IDMEHelper = proxyquire('../../../../../cartridges/int_IDME/cartridge/scripts/init/IDMETokenDataService.js', {
            ...
            '../util/IDMEHelper': {
			        parseTokenDataResponse: function () {
				                return {
			                    token: 'aaaa',
			                    scope: 'aaa'
			                };
