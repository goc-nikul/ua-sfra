...
describe('int_OIS/cartridge/scripts/order/exchangeOrderHelper.js', () => {
    it('getExchangeProduct - Should be throw null if exchangeItemSKU is empty ', () => {
        let exchangeOrderHelper = proxyquire('../../../../../cartridges/int_OIS/cartridge/scripts/order/exchangeOrderHelper', {
