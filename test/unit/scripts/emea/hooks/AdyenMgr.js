...
describe('app_ua_emea/cartridge/scripts/hooks/AdyenMgr', () => {
    var result;
    var AdyenMgr = proxyquire('../../../../../cartridges/app_ua_emea/cartridge/scripts/hooks/AdyenMgr.js', {
        'app_ua_emea/cartridge/scripts/orders/ReturnsUtils': function () {
