...
var stubFitImagesAvailability = sinon.stub();
...
var stubBadges = sinon.stub();
var stubTileImages = sinon.stub();
var stubTileSwatches = sinon.stub();
var stubCustomAttributes = sinon.stub();
var stubShowTerms = sinon.stub();
var stubVideoMaterial = sinon.stub();
var stubAvailableForInStorePickup = sinon.stub();
var stubAvailabilityHealthHelpers = sinon.stub();

function proxyModel() {
    return {
        mocks: proxyquire('../../../cartridges/app_ua_core/cartridge/models/product/decorators/index', {
            ...
            '~/cartridge/models/product/decorators/fitModelImagesAvailability': stubFitImagesAvailability,
            ...
            '*/cartridge/models/product/decorators/badges': stubBadges,
            '~/cartridge/models/product/decorators/tileImages': stubTileImages,
            '~/cartridge/models/product/decorators/tileSwatches': stubTileSwatches,
            '~/cartridge/models/product/decorators/customAttributes': stubCustomAttributes,
            '~/cartridge/models/product/decorators/videoMaterial': stubVideoMaterial,
            '~/cartridge/models/product/decorators/showTerms': stubShowTerms,
            '*/cartridge/models/product/decorators/availableForInStorePickup': stubAvailableForInStorePickup,
            '*/cartridge/models/product/decorators/availabilityHealthHelpers': stubAvailabilityHealthHelpers
        }),
        ...
        stubs: {
            ...
            stubFitImagesAvailability: stubFitImagesAvailability,
            ...
            stubBadges: stubBadges,
            stubTileImages: stubTileImages,
            stubTileSwatches: stubTileSwatches,
            stubCustomAttributes: stubCustomAttributes,
            stubVideoMaterial: stubVideoMaterial,
            stubShowTerms: stubShowTerms,
            stubAvailableForInStorePickup: stubAvailableForInStorePickup,
            stubAvailabilityHealthHelpers: stubAvailabilityHealthHelpers
        }
    };
}
