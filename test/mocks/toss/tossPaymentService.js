...
function proxyModel() {
    return proxyquire('../../../cartridges/int_custom_tosspayments/cartridge/scripts/service/tossPaymentService.js',
        {
            'dw/svc/LocalServiceRegistry': {
                createService: (svcId, configObj) => {
                    return {
                        call: (data) => {
                            tossPaymentServiceHandler.configObj = configObj;
                            tossPaymentServiceHandler.data = data;
                            var serviceParams = {
                                paymentKey: 'test1234'
                            };
